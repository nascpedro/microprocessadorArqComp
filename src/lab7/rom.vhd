...
architecture a_rom of rom is
   type mem is array (0 to 127) of unsigned(14 downto 0);
    constant conteudo_rom : mem := (
        ...
        -- Zerando os registradores R3, R4 e R5
        ...
        -- Leituras (Se a RAM falhar, eles continuam zero)
        16 => "101101100000000", -- LW R3, (R0) -> Deverá ler 5
        17 => "101110000100000", -- LW R4, (R1) -> Deverá ler 15
        18 => "101110101000000", -- LW R5, (R2) -> Deverá ler 25
        ...
        -- Travando PC em um loop infinito
